      ...
      >
        ...
        >
          ...
          <span className="hidden sm:block">
            Mega<span className="text-brand-600 dark:text-brand-400"> Revision</span> Notes
          </span>
        ...
        >
          ...
          <kbd className="ml-auto text-xs px-1.5 py-0.5 rounded border border-base
      ...
      {mobileMenuOpen && (
        <>
          ...
          <div
            ...
            style={{ backgroundColor: 'var(--bg-surface)', borderColor: 'var(--border)' }}
          >
            <Sidebar currentPath={location.pathname} onNavigate={closeMobileMenu} />
          </div>
        </>
      )}
